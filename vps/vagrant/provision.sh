...
sudo sshpass -p "vagrant" ssh-copy-id -i /home/vagrant/.ssh/id_rsa vagrant@192.168.0.10  # should get from file for max secure
...
make venv
source /var/www/nasanomics/venv/bin/activate && make install
